...
// PermissionSet menyimpan pemetaan role ke daftar permission.
type PermissionSet struct {
	byRole map[string]map[string]struct{}
}

// NewPermissionSet mengubah hasil query menjadi bentuk
// yang cepat dicari.
...
// PermissionsOf mengembalikan seluruh permission
// milik sebuah role.
...
// KnownRoles mengembalikan seluruh role yang dikenal.
...
// IsKnownRole mengecek apakah role dikenal sistem.
func (p *PermissionSet) IsKnownRole(
	role string,
) bool {
