...
// ValidateRegister memvalidasi request pendaftaran user.
...
// ValidateLogin memvalidasi kelengkapan data request login.
...
// CheckPasswordStrength memeriksa kekuatan password secara murni tanpa menyentuh fiber.Ctx.
